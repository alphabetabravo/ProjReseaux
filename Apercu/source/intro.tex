...
Nous avons décidé de nommer notre projet "WifiSansPrix". Le nom scientifique du projet est : Rogue Access Point.
\newline
Notre choix pour le nom du projet est entièrement tiré du but final. 
...
Ce projet consiste à usurper l'identité d'une borne wifi pour que le traffic réseau des utilisateurs connectés soit automatiquement redirigé vers notre borne wifi corrompue.
\newline
\newline
...
\vspace{3mm}
\item
Création d'un point d'accés à l'aide de l'outil Airbase-ng
\item
...
\item
Mise en place d'une procédure ("Hameçonnage") pour récupérer la clé wifi de la vraie borne wifi
\end{itemize}
\section*{Nouvelles compétences visées}
Ce projet a pour but de nous faire comprendre l'installation, la configuration et l'analyse des outils cités précédemment.
\newline
\newline
